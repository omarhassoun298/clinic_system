...
class __TwigTemplate_89b05b9cc82b4398c6b937c1e43d47ca76af8ba5a28a78281369eb06ee0aa9aa extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t<div class=\"col-md-10\">
                            <select name=\"gender\" id=\"input-gender\" class=\"form-select\">
                                <option value=\"";
        // line 62
        echo twig_get_attribute($this->env, $this->source, ($context["user_group"] ?? null), "user_group_id", [], "any", false, false, false, 62);
        echo "\"";
        if ((twig_get_attribute($this->env, $this->source, ($context["user_group"] ?? null), "user_group_id", [], "any", false, false, false, 62) == ($context["user_group_id"] ?? null))) {
            echo " selected";
        }
        echo ">";
        echo twig_get_attribute($this->env, $this->source, ($context["user_group"] ?? null), "name", [], "any", false, false, false, 62);
        echo "</option>
                            </select>
                       </div>
\t\t\t\t\t</div>
...
";
    ...
    {
        return array (  281 => 154,  263 => 139,  257 => 136,  244 => 126,  203 => 88,  187 => 75,  178 => 69,  162 => 62,  154 => 56,  148 => 54,  146 => 53,  138 => 52,  129 => 46,  122 => 41,  116 => 39,  114 => 38,  106 => 37,  99 => 33,  85 => 21,  74 => 18,  71 => 17,  67 => 16,  62 => 14,  52 => 9,  46 => 6,  37 => 1,);
    }
