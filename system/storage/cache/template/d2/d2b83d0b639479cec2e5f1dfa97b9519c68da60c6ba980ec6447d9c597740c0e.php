...
class __TwigTemplate_ccaf6f2bd3d687eb42d605be9a56fb85ba516ddd74d8660306fe1caefd2fde74 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t<input type=\"text\" name=\"diagnosis\" id=\"input-diagnosis\" value=\"";
        ...
        echo "\" placeholder=\"Doctor diagnosis\" class=\"form-control \"/>
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
                    <div class=\"mb-3 row required\">
