...
class __TwigTemplate_a971ef14be4a1c78f2da30d0728a587ef5717771ff763052084a8ab83ddedb7b extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t<div class=\"col-md-10\">
\t\t\t\t\t\t\t<input type=\"text\" name=\"diagnosis\" id=\"input-diagnosis\" value=\"";
        // line 46
        echo ($context["diagnosis"] ?? null);
        echo "\" placeholder=\"Patient Diagnosis\" class=\"form-control \"/>
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
                    <div class=\"mb-3 row required\">
