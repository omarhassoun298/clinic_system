...
class __TwigTemplate_b44afa47b79d22d11df6d213bf04c868c62050168744b6cbacdb39c05322d7e1 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t ";
        ...
        if (($context["error_username"] ?? null)) {
            // line 39
            echo "\t\t\t\t\t\t\t\t<div id=\"error-username\" class=\"invalid-feedback d-block\">";
...
\t\t\t\t\t\t\t<input type=\"text\" name=\"phone_number\" id=\"input-telephone\" value=\"";
        ...
        echo "\" placeholder=\"Doctor Name\" class=\"form-control ";
        if (($context["error_phone_number"] ?? null)) {
            echo "is-invalid";
        }
        echo "\"/>
                            ";
        ...
        if (($context["error_phone_number"] ?? null)) {
            // line 54
            echo "\t\t\t\t\t\t\t\t<div id=\"error-username\" class=\"invalid-feedback d-block\">";
            echo ($context["error_phone_number"] ?? null);
            echo "</div>
\t\t\t\t\t\t\t ";
        }
        // line 56
...
";
    ...
    {
        return array (  255 => 140,  237 => 125,  231 => 122,  218 => 112,  177 => 74,  161 => 61,  154 => 56,  148 => 54,  146 => 53,  138 => 52,  129 => 46,  122 => 41,  116 => 39,  114 => 38,  106 => 37,  99 => 33,  85 => 21,  74 => 18,  71 => 17,  67 => 16,  62 => 14,  52 => 9,  46 => 6,  37 => 1,);
    }
