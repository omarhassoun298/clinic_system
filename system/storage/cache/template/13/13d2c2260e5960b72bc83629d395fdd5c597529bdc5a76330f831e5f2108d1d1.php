...
class __TwigTemplate_feef066c188205c1f7eba1caab973de6ab674b580c395c842746face767402e2 extends Template
{
    private $source;
    private $macros = [];
        ...
        if (($context["doctors"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["doctor"]) {
                ...
                echo "</td>
                  <td class=\"text-left\">";
                // line 62
                echo twig_get_attribute($this->env, $this->source, $context["doctor"], "phine", [], "any", false, false, false, 62);
                echo "</td>
