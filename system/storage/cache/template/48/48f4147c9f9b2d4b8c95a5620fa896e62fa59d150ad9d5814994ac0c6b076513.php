...
class __TwigTemplate_adc7fe0d239b2f02c3ef4419cdb2d1cd5b5d3b8c9c6495f1a86af3ee70e84291 extends Template
{
    private $source;
    private $macros = [];
...
\$('#input-doctor').autocomplete({
    'source': function (request, response) {
        ...
        echo "&filter_username=' + encodeURIComponent(request),
            ...
            success: function (json) {
                response(\$.map(json, function (item) { // Pass the JSON response to \$.map
                    return {
                        value: item['doctor_id'], // The hidden value (doctor_id)
                        label: item['username']  // The visible label (username)
                    };
                }));
            }
        });
    ...
    'select': function (item) {
        \$('#input-doctor').val(item['label']); // Set the visible input
        \$('#input-doctor-id').val(item['value']); // Set the hidden input
    }
});
...
";
    ...
    {
        return array (  265 => 134,  242 => 114,  229 => 104,  208 => 86,  204 => 85,  199 => 83,  190 => 77,  181 => 71,  169 => 64,  163 => 63,  154 => 56,  148 => 54,  146 => 53,  138 => 52,  129 => 46,  122 => 41,  116 => 39,  114 => 38,  106 => 37,  99 => 33,  85 => 21,  74 => 18,  71 => 17,  67 => 16,  62 => 14,  52 => 9,  46 => 6,  37 => 1,);
    }
