...
class ControllerFeedRestApi extends RestController{
    ...
    private function getStore($id){
        try {
            $this->json['data']['customer'] = $this->customer->getCustomer();
            $this->json['data']['default_country_id'] = (int)$this->config->get('module_setting_default_country_id');
            $this->json['data']['default_iso_code'] = $this->config->get('module_setting_default_iso_code_2');
            $this->json['data']['default_zone_id'] = (int)$this->config->get('module_setting_default_zone_id');
            $this->json['data']['default_nationality'] = $this->config->get('module_setting_default_nationality');
            $this->json['data']['max_image_size'] = (int)4;
            $this->json['data']['input_telephone_countries'] = ['LB'];
        } catch (Exception $e) {
...
//            );
    ...
    public function nationalities(){
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'GET') {
            ...
            $this->json['data'] = $this->config->get('module_setting_nationalities');
